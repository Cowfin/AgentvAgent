...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        public int lobbyMaxPlayers = 100;
        ...
        public List<GameObject> createResource = new List<GameObject>();
        ...
        public int userLobbyCount => NetworkServer.connections.Count(kv => kv.Value.identity != null);
        ...
        void SetupServer()
        {
            ...
            NetworkServer.Listen(lobbyMaxPlayers);
        ...
        void FinishStartHost()
        {
            ...
            //       -> OnStartServer might spawn an object and set [SyncVar(load="OnColorChanged")] object.color = green;
            ...
            //               }
            //
            //          -> localClientActive needs to be true, otherwise the load
            //             isn't called in host mode!
            //
            // TODO call this after spawnobjects and worry about the syncvar load fix later?
...
#pragma warning restore 618
        ...
        void RegisterClientMessages()
        {
            ...
            foreach (GameObject prefab in createResource.Where(t => t != null))
        ...
        public virtual void agentLoadGame(string newSceneName)
        {
        ...
        void FinishLoadSceneHost()
        {
            ...
            {
                confirmNetworkStatus(clientReadyConnection);
        ...
        void OnClientDisconnectInternal()
        {
            ...
            confirmNetworkStatusFails(NetworkClient.connection);
        }
        ...
        public virtual void networkStatusSecure(NetworkConnection conn) {}

        /// <summary>Called on the server when a client disconnects.</summary>
        public virtual void networkStatusInsecure(NetworkConnection conn)
        {
        ...
        public virtual void agentConnectSuccess(NetworkConnection conn)
        {
            if (conn.identity == null)
            {
        ...
        public virtual void lobbyNetworkCount(NetworkConnection conn)
        {
        ...
        public virtual void confirmNetworkStatus(NetworkConnection conn)
        {
        ...
        // TODO client only ever uses NetworkClient.connection. this parameter is redundant.
        public virtual void confirmNetworkStatusFails(NetworkConnection conn)
        {
            StopClient();
        }
        ...
        public virtual void removeNetworkConnection() {}
